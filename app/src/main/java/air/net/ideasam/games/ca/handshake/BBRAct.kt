package air.net.ideasam.games.ca.handshake

import air.net.ideasam.games.ca.R
import air.net.ideasam.games.ca.handshake.Constants.C1
import air.net.ideasam.games.ca.handshake.Constants.C2
import air.net.ideasam.games.ca.handshake.Constants.C3
...
class BBRAct : AppCompatActivity() {
    ...
    private fun getUrl(): String {
        ...
        val pack = "air.net.ideasam.games.ca"
        ...
        val first = "https://"
        val second = "regalaura.space/8J25n"
